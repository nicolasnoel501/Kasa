  ...
  return (
    <div className="main">
        ...
        <div className="main__container">
          <div>
            <div className="main__city__container">
              <h1 className="main__city__container__title1">{housing.title}</h1>
              <h2 className="main__city__container__title2">
                {housing.location}
              </h2>
            </div>
            <div>
          ...
          <div>
            <div className="main__stars__container">
              <div className="main__stars__container__host">
                ...
                <img
                  className="main__stars__container__host__img"
      ...
      <div className="main__collapse">
        <Collapse
          title="Description"
          content={{ type: "paragraph", text: housing.description }}
        />
        <Collapse
          title="Équipements"
          content={{ type: "list", items: housing.equipments }}
        />
      </div>
    </div>
  );
